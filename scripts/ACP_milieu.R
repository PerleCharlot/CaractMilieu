...
# Dates de modification : 16-08-2022
...
ACP_axesFAMD <- function(mois, palette_couleur=mypalette){
  ...
  liste_axes = liste_axes[!grepl("toutes|ACP_FAMD",liste_axes)]
...
corresp_col = data.frame(dim_name = c("CA","B","PV","CS","D","I","toutes"),
                         colour_dim = c("dodgerblue","darkgoldenrod1","darkgreen",
...
# # Relancer FAMD sur CA (avec échange 10 vars clima VS ACP1)
# fct_FAMD("CS")
